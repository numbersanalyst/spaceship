...
Command: npx @threlte/gltf@2.0.1 C:\Users\Michal\Favorites\Programing\spaceship\static\models\spaceship.glb --root /models/ --printwidth 120 --precision 2
...
<script>
	...
	gltf.then((model) => {
		...
		fixAlpha(model.materials.spaceship_racer);
		fixAlpha(model.materials.cockpit);
	});
...
<T is={ref} dispose={false} {...$$restProps} bind:this={$component}>
	{#await gltf}
		<slot name="fallback" />
	{:then gltf}
		<T.Group scale={0.003} rotation={[0, -Math.PI * 0.5, 0]} position={[0.9, 0, -2.235]}>
			<T.Mesh
				castShadow
				receiveShadow
